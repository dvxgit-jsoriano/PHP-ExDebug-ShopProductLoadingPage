...
<body>
            ...
            <div class="max-w-sm rounded-xl overflow-hidden shadow-lg w-1/4 p-4">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-gray-700 text-base">
                        ...
                        Price: PHP $product->price_php
                    </p>
                </div>
                <div class="px-6 pt-4 pb-2">
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#Category: Beverages</span>
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#SubCategory: SoftDrinks</span>
                </div>
            </div>
            PRODUCT;
        }
    ...
    <div class="flex justify-center my-8 px-12">
        <button class="px-8 py-4 w-full rounded text-gray-50 bg-gray-800" onclick="load();">Load More</button>
    </div>
